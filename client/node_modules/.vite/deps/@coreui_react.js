...
var CAccordionButton = (0, import_react9.forwardRef)(function(_a, ref) {
  var children = _a.children, className = _a.className, rest = __rest(_a, ["children", "className"]);
  var _b = (0, import_react9.useContext)(CAccordionItemContext), visible = _b.visible, setVisible = _b.setVisible;
...
var CBreadcrumbItem = (0, import_react20.forwardRef)(function(_a, ref) {
  ...
  return import_react20.default.createElement("li", __assign({ className: classNames("breadcrumb-item", {
    active
  }, className) }, active && { "aria-current": "page" }, rest, { ref }), href ? import_react20.default.createElement(CLink, { href }, children) : children);
});
...
var CButton = (0, import_react21.forwardRef)(function(_a, ref) {
  ...
  return import_react21.default.createElement(CLink, __assign({ as: rest.href ? "a" : as }, !rest.href && { type }, { className: classNames("btn", variant ? "btn-".concat(variant, "-").concat(color) : "btn-".concat(color), (_b = {}, _b["btn-".concat(size)] = size, _b), shape, className) }, rest, { ref }), children);
});
CButton.propTypes = {
...
CConditionalPortal.propTypes = {
  ...
  // HTMLElement
  portal: import_prop_types39.default.bool
};
...
var usePopper = function() {
  ...
  var initPopper = function(reference, popper, options) {
    _popper.current = createPopper2(reference, popper, options);
    el.current = popper;
  };
...
var CDropdown = (0, import_react41.forwardRef)(function(_a, ref) {
  var _b;
  var children = _a.children, alignment = _a.alignment, _c = _a.as, as = _c === void 0 ? "div" : _c, _d = _a.autoClose, autoClose = _d === void 0 ? true : _d, className = _a.className, container = _a.container, dark = _a.dark, direction = _a.direction, _e = _a.offset, offset = _e === void 0 ? [0, 2] : _e, onHide = _a.onHide, onShow = _a.onShow, _f = _a.placement, placement = _f === void 0 ? "bottom-start" : _f, _g = _a.popper, popper = _g === void 0 ? true : _g, _h = _a.portal, portal = _h === void 0 ? false : _h, _j = _a.variant, variant = _j === void 0 ? "btn-group" : _j, _k = _a.visible, visible = _k === void 0 ? false : _k, rest = __rest(_a, ["children", "alignment", "as", "autoClose", "className", "container", "dark", "direction", "offset", "onHide", "onShow", "placement", "popper", "portal", "variant", "visible"]);
...
var CDropdownMenu = (0, import_react46.forwardRef)(function(_a, ref) {
  ...
  return import_react46.default.createElement(
    ...
    import_react46.default.createElement(Component, __assign({ className: classNames("dropdown-menu", {
      show: visible
    }, alignment && getAlignmentClassNames(alignment), className), ref: forkedRef, role: "menu", "aria-hidden": !visible }, !popper && { "data-coreui-popper": "static" }, dark && { "data-coreui-theme": "dark" }, rest), Component === "ul" ? import_react46.default.Children.map(children, function(child, index) {
...
var CDropdownToggle = function(_a) {
  ...
  var Toggler = function() {
    ...
    if (variant === "nav-item" && navLink) {
      return import_react47.default.createElement("a", __assign({ href: "#" }, togglerProps, { role: "button", ref: dropdownToggleRef }), children);
    }
...
var CRow = (0, import_react66.forwardRef)(function(_a, ref) {
  ...
  return import_react66.default.createElement("div", { className: classNames("row", repsonsiveClassNames, className), ref }, children);
});
...
var CListGroup = (0, import_react74.forwardRef)(function(_a, ref) {
  ...
  return import_react74.default.createElement(Component, { className: classNames("list-group", (_b = {
...
var CNavGroup = (0, import_react86.forwardRef)(function(_a, ref) {
  ...
  var _c = (0, import_react86.useState)(), height = _c[0], setHeight = _c[1];
  ...
  return import_react86.default.createElement(
    ...
    toggler && import_react86.default.createElement("a", { className: "nav-link nav-group-toggle", onClick: function(event) {
...
var CPopover = (0, import_react105.forwardRef)(function(_a, ref) {
  ...
  var uID = (0, import_react105.useRef)("popover".concat(Math.floor(Math.random() * 1e6)));
  var _h = usePopper(), initPopper = _h.initPopper, destroyPopper = _h.destroyPopper;
  var _j = (0, import_react105.useState)(false), mounted = _j[0], setMounted = _j[1];
  var _k = (0, import_react105.useState)(visible), _visible = _k[0], setVisible = _k[1];
  ...
  return import_react105.default.createElement(
    ...
    import_react105.default.createElement(CConditionalPortal, { container, portal: true }, mounted && import_react105.default.createElement(
      "div",
      __assign({ className: classNames("popover", "bs-popover-auto", className), id: uID.current, ref: forkedRef, role: "tooltip" }, rest),
...
var CSidebar = (0, import_react106.forwardRef)(function(_a, ref) {
  ...
  var _c = (0, import_react106.useState)(), inViewport = _c[0], setInViewport = _c[1];
  var _d = (0, import_react106.useState)(false), mobile = _d[0], setMobile = _d[1];
  var _e = (0, import_react106.useState)(false), visibleMobile = _e[0], setVisibleMobile = _e[1];
  var _f = (0, import_react106.useState)(visible !== void 0 ? visible : overlaid ? false : true), visibleDesktop = _f[0], setVisibleDesktop = _f[1];
  ...
  return import_react106.default.createElement(
    ...
    null,
    import_react106.default.createElement("div", __assign({ className: classNames("sidebar", (_b = {}, _b["sidebar-".concat(colorScheme)] = colorScheme, _b["sidebar-narrow"] = narrow, _b["sidebar-overlaid"] = overlaid, _b["sidebar-".concat(placement)] = placement, _b["sidebar-".concat(position)] = position, _b["sidebar-".concat(size)] = size, _b["sidebar-narrow-unfoldable"] = unfoldable, _b.show = mobile && visibleMobile || overlaid && visibleDesktop, _b.hide = visibleDesktop === false && !mobile && !overlaid, _b), className) }, rest, { ref: forkedRef }), children),
...
CToast.propTypes = {
  ...
  key: import_prop_types126.default.number,
...
var CTooltip = (0, import_react132.forwardRef)(function(_a, ref) {
  ...
  var uID = (0, import_react132.useRef)("tooltip".concat(Math.floor(Math.random() * 1e6)));
  var _h = usePopper(), initPopper = _h.initPopper, destroyPopper = _h.destroyPopper, updatePopper = _h.updatePopper;
  var _j = (0, import_react132.useState)(false), mounted = _j[0], setMounted = _j[1];
  var _k = (0, import_react132.useState)(visible), _visible = _k[0], setVisible = _k[1];
  var _delay = typeof delay === "number" ? { show: delay, hide: delay } : delay;
  var popperConfig = {
    modifiers: [
      {
  ...
  return import_react132.default.createElement(
    ...
    import_react132.default.createElement(CConditionalPortal, { container, portal: true }, mounted && import_react132.default.createElement(
      "div",
      __assign({ className: classNames("tooltip", "bs-tooltip-auto", className), id: uID.current, ref: forkedRef, role: "tooltip" }, rest),
...
var useColorModes = function(localStorageItemName) {
  ...
  var _a = (0, import_react139.useState)(getPreferredColorScheme(localStorageItemName)), colorMode = _a[0], setColorMode = _a[1];
